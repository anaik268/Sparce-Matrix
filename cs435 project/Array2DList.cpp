...
ListEntry* Array2DList::nextRowEntry(const ListEntry* e) {

}

ListEntry* Array2DList::nextColEntry(const ListEntry* e) {

}

bool Array2DList::isLastEntryInRow(const ListEntry* e) {

}

bool ListEntry* Array2DList::isLastEntryInCol(const ListEntry* e) {
